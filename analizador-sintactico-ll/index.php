    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <form method="post" action="procesar.php" class="form-horizontal" role="form">
        ...
        <div class="col-sm-6 blog-main">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <ul>
                <li>Recursividad y Ambiguedad</li>
                <li>Primero y Siguiente</li>
                <li>Tabla LL</li>
                <li>Tabla de Análisis Sintactico LL</li>
              </ul>
            </div>
          </div>
        </div><!-- /.blog-main -->
